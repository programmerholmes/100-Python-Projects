...
Original file is located at
    https://colab.research.google.com/drive/1-BAIqPwJXHlg4DNH6DyaWcl7G2wrnipg
...
fig = px.pie(labels=biology.index, values=biology.values, title="Percentage of Male vs. Female Winners", names=biology.index, hole=0.4,)
