...
Original file is located at
    https://colab.research.google.com/drive/17kYLkCt09QqTZSjGjQXj_uOXhcw4NeBj
...
"""Either do it manually 1 by 1, or in a loop with the following method
...
max_revenue = data['USD_Worldwide_Gross'].max() - data['USD_Domestic_Gross'].max()
max_revenue

min_revenue = data['USD_Worldwide_Gross'].min() - data['USD_Domestic_Gross'].min()
min_revenue
...
print(f"Number of films not released yet: {len(future_releases)}")
future_releases

data_clean = data[data['Release_Date'] <=scrape_date]

"""Or a better way of doing it would be"""
