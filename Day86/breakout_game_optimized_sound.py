...
# This keeps the project simple: no extra files, no installs.
# On non-Windows computers, the game still works silently.
# ---------------------------------------------------------
try:
    import winsound
...
def play_sound(sound_name):
    """Plays a short system sound on Windows without slowing the game down."""
    if not sound_enabled or not SOUND_AVAILABLE:
        return

    sound_aliases = {
        "paddle": "SystemAsterisk",
        "brick": "SystemExclamation",
        "life": "SystemHand",
        "win": "SystemQuestion",
    ...
    try:
        winsound.PlaySound(
            sound_aliases.get(sound_name, "SystemDefault"),
            winsound.SND_ALIAS | winsound.SND_ASYNC,
        )
    except RuntimeError:
        # If Windows cannot find a system sound alias, ignore it.
        pass
