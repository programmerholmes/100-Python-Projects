...
df_btcd_monthly = df_btc_price.resample(rule='ME', on='DATE').last()
df_btcd_monthly_average = df_btc_price.resample(rule='ME', on='DATE').mean()

print(df_btcd_monthly.shape)
df_btcd_monthly.head()
...
#plt.show()  in case you're in pycharm or somewhere else.
...
ax1.set_xlim([df_btcd_monthly.index.min(), df_btcd_monthly.index.max()])
# Experiment with the linestyle and markers
ax1.plot(df_btcd_monthly.index, df_btcd_monthly.CLOSE,
         color='#F08F2E', linewidth=3, linestyle='--')
ax2.plot(df_btcd_monthly.index, df_btc_search.BTC_NEWS_SEARCH,
